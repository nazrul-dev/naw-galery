<div>
    <div>
        <div class="flex flex-col justify-between items-center mb-5 md:text-base text-sm">

            <div class="flex">
                <div class="mr-2">
                    <select wire:model="packet" class="px-2 py-1 rounded-lg form-select">
                ...
                <div class="bg-white flex items-center rounded">
                    <input
                        class="rounded-lg w-full py-1 border-gray-300 ring-0 focus:ring-gray-200 focus:ring-0 border-2 px-6 text-gray-700 leading-tight focus:outline-none"
                        wire:model="search" type="search" placeholder="Search">
                    ...
                    @foreach ($resellers as $item)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <span class="font-semibold"> Reseller</span>
                            </td>
                            <td class="py-3 px-6 text-center">
                                @if ($item->active)
                                    <span
